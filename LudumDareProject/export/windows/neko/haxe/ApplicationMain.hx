...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Joshua", "LudumDareProject", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "LudumDareProject";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "LudumDareProject", null, { width: 640, height: 480 });
